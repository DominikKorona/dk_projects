...
#define SENS_5_Pin GPIO_PIN_4
#define SENS_5_GPIO_Port GPIOA
#define SENS_3_Pin GPIO_PIN_5
...
#define B_PWM_Pin GPIO_PIN_9
#define B_PWM_GPIO_Port GPIOA
#define A_PWM_Pin GPIO_PIN_10
#define A_PWM_GPIO_Port GPIOA
