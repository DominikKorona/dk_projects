...
try:
    while True:
        ...
        cv2.imwrite('/home/roosterpi/Documents/Github/dk_projects/ZZUM_laboratorium/cam_/lf_cropped.jpg', cropped_img)
        ...
        if M_total["m00"] > 0:
            ...
            cv2.circle(output_img, (cX, cY + start_height), 10, (0, 255, 0), -1)  # Zielony punkt
